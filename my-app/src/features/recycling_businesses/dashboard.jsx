            ...
            <div className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                        ...
                        <button className="bg-primary hover:bg-secondary text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-sm flex items-center gap-2 transition-colors h-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex flex-col">
                        ...
                        <div className="relative h-64 w-full flex items-end justify-between px-4 pb-8 border-b border-l border-slate-200 gap-2">
                            ...
                            {/* SVG Line */}
                            <svg className="absolute bottom-0 left-0 w-full h-64 pointer-events-none z-10" preserveAspectRatio="none">
                                <path
